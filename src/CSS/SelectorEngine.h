...
private:
    void applyComplexSelectorToElement(const std::shared_ptr<ComplexSelector> &complexSelector, std::vector<std::shared_ptr<Declaration>> declarations, const std::shared_ptr<Node> &element);
    void run();
